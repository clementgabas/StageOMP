# --- Plot functions
def plot_sub_data(subplot_axe_object, axe: [int, int], data1, data2, xlim: (int, int), ylim: (int, int), title: str, invert_x: bool = True, invert_y: bool = False, color = 'red', _marker = '+'):
    ...
    subplot_axe_object[axe[0], axe[1]].scatter(
        data1, data2, marker=_marker, c=color)
